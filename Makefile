...
CCMD = $(CXX) -DTBB_SUPPRESS_DEPRECATED_MESSAGES=1 -std=c++20 -I ~/local/include $(SFMLINCS) -c -o $@ $< -Wall -Wextra -Woverloaded-virtual -pedantic-errors -I ~/local/include $(OPTS)
